<template>
  <PageWrapper dense contentFullHeight fixedHeight contentClass="flex">
    ...
    <EditMenu class="w-2/4 xl:w-2/5" @select="handleMenu" />
    <BasicTable class="w-1/4 xl:w-2/5" @register="registerTable" @fetch-success="onFetchSuccess">
      <template #toolbar>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'MenuManagement',
    components: { BasicTable, EditMenu, PageWrapper, MenuDrawer, DeptTree, TableAction },
    setup() {
